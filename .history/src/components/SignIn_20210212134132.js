...
const SignIn=()=>{
    ...
    return(
        <div>
            ...
            <button className='login-btn' onClick={signInWithGitHub}>Sign in with GitHub</button>
            <button className='login-btn' onClick={signInWithFacebook}>Sign in with Facebook</button>
